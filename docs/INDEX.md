...
| **[plans/](file:///c:/projects/cross/collection_book/docs/plans/)** | **Implementation Plans** | Directory for all technical, feature, and architectural implementation plans. **Each plan has its own dedicated directory** (see [plans/README.md](file:///c:/projects/cross/collection_book/docs/plans/README.md) and [agent.md](file:///c:/projects/cross/collection_book/agent.md)). Includes the [Monorepo & CBK Edge](plans/monorepo-cbk-edge/plan.md) vertical slice, the [VPS Landing & Privacy Launch](plans/cbk-vps-landing-launch/plan.md) surface, and 7 core GTM engineering plans: [Viral Receipts](file:///c:/projects/cross/collection_book/docs/plans/gtm-in-app-viral-receipts/plan.md), [Paywall & Licensing](file:///c:/projects/cross/collection_book/docs/plans/gtm-freemium-paywall-licensing/plan.md), [UPI Edge Pipeline](file:///c:/projects/cross/collection_book/docs/plans/gtm-upi-checkout-edge-pipeline/plan.md), [Vernacular i18n](file:///c:/projects/cross/collection_book/docs/plans/gtm-vernacular-localization/plan.md), [Release & ASO](file:///c:/projects/cross/collection_book/docs/plans/gtm-android-release-aso-pipeline/plan.md), [Outbound CLI](file:///c:/projects/cross/collection_book/docs/plans/gtm-outbound-scraping-campaign-cli/plan.md), and [Funnel Telemetry](file:///c:/projects/cross/collection_book/docs/plans/gtm-acquisition-telemetry-funnel/plan.md). |
